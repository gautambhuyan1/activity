...
public abstract class ActivityDetailsView extends AppCompatActivity {
    ...
    protected TextView tvHeader,tvPlaceName,tvShareCount,tvLikeCount,tvCityName,tvDetails,tvName,tvDate,tvTime,tvCommentCount;
    ...
    private void setSize() {
        ...
        llparams.setMargins(0, (int) (DeviceResolution.getScreenHeight(this) * 0.020), 0, (int) (DeviceResolution.getScreenHeight(this) * 0.010));
        ...
        rlparams.addRule(RelativeLayout.CENTER_VERTICAL);
        rlparams.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
        tvPlaceName.setLayoutParams(rlparams);
        ...
        tvCityName.setLayoutParams(llparams);

        llparams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        llparams.setMargins((int) (DeviceResolution.getScreenWidth(this) * 0.030), 0, (int) (DeviceResolution.getScreenWidth(this) * 0.010), 0);
        tvDetails.setLayoutParams(llparams);llparams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
    ...
    private void setTextSize() {
        tvHeader.setTextSize((float) (DeviceResolution.getScreenInches(this) * 3));
        tvPlaceName.setTextSize((float) (DeviceResolution.getScreenInches(this) * 3));
