...
public class InterestAdaptor extends BaseAdapter implements View.OnClickListener {
    ...
    public InterestAdaptor(Activity a, LayoutInflater lytIflator, ArrayList<String> aL) {
    ...
    public View getView(int pos, View convert, ViewGroup parent) {
        ...
        if (convert == null) {
            convert = layoutIflater.inflate(R.layout.activity_listview09, parent, false);
    ...
    public void onClick(View v) {
        ...
        ((MainActivity)groupActivity).getActivitiesOnInterest(jsonInterest);
    }
